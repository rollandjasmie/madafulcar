...
models = [
	...
	"ZZ1"tmp/cache/assets/sprockets/v3.0/_N/_N4ONgzFyhFWYO46sDZH6fDZpKiU4dlSGCSLeffs2vs.cache
	]
...
prices = [16000,15000, 600000, 150000, 35000, 35000, 60000]
pricesLocation = [16,23, 21, 18, 17, 18, 28]
